...
[data-testid="stSidebar"] {
    ...
    border-right: 1px solid #B0CEB3 !important;
}
[data-testid="stSidebar"] * {
...
[data-testid="stChatMessage"] {
    ...
    border: 1px solid #B0CEB3 !important;
...
.stTabs [data-baseweb="tab-list"] {
    ...
    border-bottom: 1px solid #B0CEB3 !important;
}
...
.stTabs [aria-selected="true"] {
    ...
    border-bottom: 2.5px solid #1A3020 !important;
...
# ── ÕPPEMATERJALI LOOMINE ─────────────────────────────────────────────────────
    ...
    st.markdown("""
    <div style='padding:1.25rem 0 0.75rem;'>
        <h1 style='font-family:"Cormorant Garamond",serif; font-size:1.9rem;
                   font-weight:600; color:#1A3020; margin:0;'>
            Lihtsustatud õppematerjali loomine 🎓
        </h1>
        <p style='color:#1A3D1E; font-size:0.95rem; margin-top:0.35rem; line-height:1.6;'>
            Loo kohe valmis õppematerjal — sisesta teema ja AI koostab selle sinu õpilasele sobivaks 💚
        </p>
    </div>
    """, unsafe_allow_html=True)
