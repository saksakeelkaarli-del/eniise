...
[data-testid="stSidebar"] {
    ...
    border-right: 2px solid #0D1A0F !important;
}
[data-testid="stSidebar"] * {
...
[data-testid="stChatMessage"] {
    ...
    border: 1.5px solid #2A6035 !important;
...
[data-testid="stChatInput"] textarea {
    ...
    background: #fff !important;
    font-size: 15px !important;
    border: 2px solid #2A6035 !important;
}
/* All buttons: medium green bg, white text */
.stButton > button {
    font-family: 'Jost', sans-serif !important;
    font-size: 15px !important;
...
.stButton > button:hover {
    background-color: #2A6035 !important;
    border-color: #2A6035 !important;
    color: #ffffff !important;
}
/* Primary buttons: gold accent */
.stButton > button[kind="primary"] {
    background-color: #C89030 !important;
    border-color: #C89030 !important;
    color: #ffffff !important;
}
.stButton > button[kind="primary"]:hover {
    background-color: #A87020 !important;
    border-color: #A87020 !important;
}
.stTabs [data-baseweb="tab-list"] {
    background: transparent !important;
    border-bottom: 2px solid #2A6035 !important;
}
...
.stTabs [aria-selected="true"] {
    color: #0D1A0F !important;
    border-bottom: 3px solid #1A3020 !important;
...
h1, h2, h3 { color: #0D1A0F !important; }
.stMarkdown p { font-size: 15.5px !important; color: #0D1A0F !important; }
[data-testid="stSelectSlider"] { font-size: 15px !important; }
/* Download button */
[data-testid="stDownloadButton"] > button {
    background-color: #1A3020 !important;
    color: #fff !important;
    border: 2px solid #1A3020 !important;
    font-weight: 600 !important;
}
...
- Kasuta emojisid sparingly, ainult siis kui aitavad mõistmisele kaasa
...
if leht == "avaleht":
    ...
    <div style='position:relative; border-radius:18px; overflow:hidden;
                ...
                background:linear-gradient(135deg, #1A3020 0%, #2A5035 60%, #3A7050 100%);
                display:flex; align-items:center;'>
        <img src='https://images.unsplash.com/photo-1588072432836-e10032774350?w=1200&q=80&fit=crop'
             style='position:absolute;inset:0;width:100%;height:100%;object-fit:cover;opacity:0.18;border-radius:18px;'>
        <div style='position:relative;z-index:2;padding:2rem 2.5rem;'>
            <h1 style='font-family:"Cormorant Garamond",serif; font-size:2.4rem;
                       font-weight:600; color:#fff; margin:0; letter-spacing:-0.5px; line-height:1.15;'>
                Tere tulemast Eniisesse 🌿
            </h1>
            <p style='color:#C8EDD0; font-size:1rem; margin-top:0.5rem; line-height:1.55;'>
...
# ── ASSISTENT ─────────────────────────────────────────────────────────────────
    ...
    <div style='position:relative; border-radius:16px; overflow:hidden;
                margin:0.75rem 0 1.25rem; height:130px;
                background:linear-gradient(135deg, #1A3020, #2A5035);'>
        <img src='https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=900&q=80&fit=crop'
             style='position:absolute;inset:0;width:100%;height:100%;object-fit:cover;opacity:0.2;'>
        <div style='position:relative;z-index:2;padding:1.4rem 2rem;'>
            <h1 style='font-family:"Cormorant Garamond",serif; font-size:1.8rem;
                       font-weight:600; color:#fff; margin:0;'>
                AI Assistent 💬
            </h1>
            <p style='color:#C8EDD0; font-size:0.9rem; margin-top:0.2rem;'>
...
# ── LIHTNE KEEL ───────────────────────────────────────────────────────────────
    ...
    <div style='position:relative; border-radius:16px; overflow:hidden;
        ...
        <img src='https://images.unsplash.com/photo-1455390582262-044cdead277a?w=900&q=80&fit=crop'
             style='position:absolute;inset:0;width:100%;height:100%;object-fit:cover;opacity:0.2;'>
        <div style='position:relative;z-index:2;padding:1.4rem 2rem;'>
            <h1 style='font-family:"Cormorant Garamond",serif; font-size:1.8rem;
                       font-weight:600; color:#fff; margin:0;'>
            ...
            <p style='color:#C8D8F0; font-size:0.9rem; margin-top:0.2rem;'>
...
# ── ÕPPEMATERJALI LOOMINE ─────────────────────────────────────────────────────
    ...
    <div style='position:relative; border-radius:16px; overflow:hidden;
        ...
        <img src='https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=900&q=80&fit=crop'
        ...
        <div style='position:relative;z-index:2;padding:1.4rem 2rem;'>
            ...
            <p style='color:#F0D8B8; font-size:0.9rem; margin-top:0.2rem;'>
    ...
    with col_tulemus:
        ...
        if st.session_state.materjal_tulemus:
            ...
            <div style='background:#fff; border:1px solid #B0CEB3; border-radius:14px;
                        ...
                        color:#0D1A0F; white-space:pre-wrap; min-height:400px;'>
{st.session_state.materjal_tulemus}
            </div>
            """, unsafe_allow_html=True)
